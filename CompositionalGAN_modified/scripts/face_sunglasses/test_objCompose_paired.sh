...
datalist="dataset/${name}/test_valid.txt"
datalist_t="dataset/${name}/test_valid.txt"
datalist_test_surfnorm="dataset/${name}/test_surfnorm.txt"

exp_name="paired_compGAN_notCropSurfnorm"
...
CUDA_LAUNCH_BLOCKING=${CUDA_ID} CUDA_VISIBLE_DEVICES=${CUDA_ID} python3 test_composition.py --datalist ${datalist} --datalist_test ${datalist_t} \
								 ...
								 --how_many 300 --eval --STN_model='deep' --datalist_surfnorm ${datalist_test_surfnorm}\
